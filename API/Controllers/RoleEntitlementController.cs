...
using NewCode.Models;
using NewCode.Data;
using NewCode.Filter;
using NewCode.Entities;
using NewCode.Authorization;
using Microsoft.AspNetCore.Authorization;

namespace NewCode.Controllers
{
    /// <summary>
    ...
    {
        private readonly NewCodeContext _context;

        public RoleEntitlementController(NewCodeContext context)
        {
            _context = context;
        }
