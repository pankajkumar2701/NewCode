...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "NewCode", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<NewCodeContext>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "NewCode API v1");
